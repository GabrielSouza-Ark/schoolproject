...
$consulta = mysqli_query($conecta,"SELECT * FROM ocorrencias WHERE id_ocorrencia = '$idocorrencia'");
?>
	<div>
 <br><br><br><br><br><br>
	<div class="container">
		<p class="text-center display-4">EXCLUIR A OCORRENCIA?</p>
...
<thead class="thead-light">
		...
		<div class="w3-center">
	 	<div class="w3-bar">
	 	<br>
	 	<form name="formexclui" method="POST" action="excluiocorrencia.php?idocorrencia=<?php echo $codigo;?>&dois=<?php echo $_GET['volta'];?>">
