  ...
  <nav class="navbar navbar-expand-sm">
   <button class="btn btn-secondary btn-right" type="submit" href="index.html">SAIR</button>
		...
		?>
					...
					<br><br><br><br><br><br>
					  <div class="container">
					    <p class="text-center display-4">EXCLUIR O GESTOR?</p><br>
				        ...
				        <th>DATA DE NASCIMENTO</th>
					        ...
					        <div class="w3-center">
								...
								<label> Tem certeza que deseja excluir o registro? </label>
							 	<br>
							 	<form name="formexclui" method="POST" action="excluigestao.php?id=<?php echo $codigo;?>&dois=<?php echo $_GET['volta'];?>">
