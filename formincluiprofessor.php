...
<br><br><br><br><br>
    ...
    <div>
<div class="container">
<p class="text-center display-4">INCLUIR UM PROFESSOR</p>


    <form name="forminclui" method="POST" action="insereprofessor.php?dois=<?php echo $_GET['volta'];?>">
    ...
    <div  class="w3-container">
      ...
      <input class="form-control" type="text" name="especialista" required="yes"> <br>
      ...
      <input class="form-control" type="text" name="telefone" required="yes">
      <br>      
