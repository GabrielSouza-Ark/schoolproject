...
?>
	...
	<br><br><br><br><br><br>
	<div class="container">
		<p class="text-center display-4">EXCLUIR O INFORMATIVO?</p>
...
<thead class="thead-light">
	  ...
	  ?>
		...
		<div class="w3-center">
	 	<div class="w3-bar">
	 	<br>
	 	<form name="formexclui" method="POST" action="excluiinformativo.php?id=<?php echo $codigo;?>&dois=<?php echo $_GET['volta'];?>"">
