...
$id = $_GET['id'];
$consulta = mysqli_query($conecta,"SELECT * FROM falta WHERE id = '$id'");
$registro = mysqli_fetch_array($consulta);
$falta = $registro[2];
$data = $registro[3];
?>

	<form name="formaltera" method="POST" action="alterafalta.php?dois=<?php echo $_GET['volta'];?>" >
 <br><br><br><br><br>
  <div class="container">
    <p class="text-center display-4">ALTERAR A FALTA?</p>

  
	<form name="formaltera" method="POST" action="alterafalta.php">
        ...
        <label>Motivo</label>
        <input class="form-control" type="text" name="falta" value="<?php echo $falta;?>">
        <br>
